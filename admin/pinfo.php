    ...
    <body>
        ...
        <div>
		  ...
		  Recherche du nom de compte, de perso ou du guid dans les personnages:
            ...
            $filtre = "'" . $_POST['filtre'] . "'";
            $sql = mysql_query("SELECT c.guid, c.name, c.race, c.class, c.level, c.gender, c.money AS money, a.username, a.id
					   FROM characters.characters AS c, realmd.account AS a
					   WHERE a.id = c.account AND (c.guid = $filtre OR c.name LIKE $filtre OR a.username LIKE $filtre)");
            ?>
