...
//252811 
$sql = mysql_query("SELECT username, id FROM site.accounts2 WHERE id > 259174");
// pour tous les comptes
while($un_compte = mysql_fetch_array($sql)) {
	$old_id =$un_compte['id'];
	$new_id = $old_id-1;
	echo "UPDATE site.accounts2 SET id=$new_id WHERE id=$old_id"."<br />";
	mysql_query("UPDATE site.accounts2 SET id=$new_id WHERE id=$old_id");
