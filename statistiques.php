...
<script LANGUAGE="Javascript" SRC="Scripts/faqrecup.js"> </SCRIPT>
		...
		<!--	<div id="textefaq1"> -->
                    ...
                    <!--      </div>
                    	 <a href=# id="titrefaq2">  <h2 class="hache1">Statistiques PVP:</h2></a>
                         
			<div id="textefaq2">
                          <p><?php require "statistiques_arene.php"  ?></p>
                          <br/>
Pour plus d'infos vous pouvez consulter l'armurerie à cette adresse: <a href="http://wowarmory.odyssee-serveur.com">http://wowarmory.odyssee-serveur.com</a>
</div>
 <a href=# id="titrefaq3"><h2 class="hache1">Statistiques PVE:</h2></a>
