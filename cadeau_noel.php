...
?>
    ...
    <input type="submit" name="ok" value="Valider"/>
        ...
        $perso = $_POST['perso'];
        $sql = "INSERT INTO characters.mail_external (`sender`,`receiver`,`subject`,`message`, `money`) "
              ."VALUES ('3', '". $perso ."', 'Pere Noël Odyssée', 'Chèr(e) joueur/joueuse, voici le cadeau de Noël Odyssée, en vous souhaitant de nombreux moments de plaisir IG et une excellente fin d\'année de la part de toute l\'équipe. Que l\'année qui suive soit pleine de promesses!.', '0')";
        $mailnoel = mysql_query($sql) or die("Erreur dans l'envoi du mail");
