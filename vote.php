...
$prochain_vote = timestamp2mysql(time()+ $temp_entre_votes);
	...
	if (isset($_POST['token'])&&$_POST['token']<>'') {
		...
		if(mysql_num_rows($check_token)==1 && $timestamp_actuel>=$timestamp_db) {
			...
			echo "<p>Vous allez être redirigé vers la page de <a href=\"http://www.rpg-paradize.com/?page=vote&vote=6408\">Rpg Paradize</a> pour finir votre vote. Remplissez le CAPTCHA! <br/>
			<META http-equiv='refresh' content='0; URL=http://www.rpg-paradize.com/?page=vote&vote=6408'>";
		} else {
