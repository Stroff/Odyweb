	...
	//1po = 10000 pieces
		...
		if (mysql_num_rows($persos) == 1) {
				...
				if ($compte_points >=$prix_po) {
					...
					mysql_query("SET NAMES 'utf8'");
					$resReqSite = mysql_query ( "INSERT INTO logs_achat_boutique SET date = NOW(), account_id = '".$id_compte."', objet_id='".$nombre_po." po', perso_id ='" . $guid_perso . "',perso_nom='".$perso['name']."'" ) or die ( mysql_error () );
