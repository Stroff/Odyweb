<?php require "include/template/header_cadres.php"  ?>
        	...
        	<div class="encadrepage-haut">
            	<div class="encadrepage-titre">
                        <br/>
                        <br/>
           	            <img src="medias/images/titre/communaute.gif" >
            	...
            	<div class="blocpage">
                    ...
                    <div class="blocpage-bas">
                    	<div class="blocpage-texte">
                    	  ...
                    	  <a href=# id="titrefaq2"><h2 class="hache1">L'équipe d'odyssée</h2></a>
			  <div id="textefaq2">
                    	  <div align="center">
                    	  <strong class="bbc"><span style="color: rgb(255, 140, 0);"> = </span><span class="bbc_underline"><span style="font-size: 21px;">Administration</span></span><span style="color: rgb(255, 140, 0);"> = </span></strong><br>
...
<br>
<strong class="bbc">Dworkin</strong><br>
<br>
...
<br>
<br>
<strong class="bbc"><span style="color: rgb(255, 140, 0);"> = </span><span class="bbc_underline"><span style="font-size: 21px;">Assistance Forum</span></span><span style="color: rgb(255, 140, 0);"> = </span></strong><br>
...
<strong class="bbc"><span style="color: rgb(255, 140, 0);"> = </span><span class="bbc_underline"><span style="font-size: 21px;">Développement</span></span><span style="color: rgb(255, 140, 0);"> = </span></strong><br>
<br>
<br>
<br>
...
<br>
<br>
<strong class="bbc"><span style="color: rgb(255, 140, 0);"> = </span><span class="bbc_underline"><span style="font-size: 21px;">Graphisme</span></span><span style="color: rgb(255, 140, 0);"> = </span></strong><br>
<br>
<br>
<br>
